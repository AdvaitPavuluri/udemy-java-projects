...
public class BankAccount {
    ...
    public BankAccount() {
        this("Default account number", 69.420, "Default name", "Default address", "Default Phone Number");
...
/*        this.customerName = customerName;
    ...
    public BankAccount(String accountNumber, double accountBalance, String customerName, String customerEmail, String customerPhoneNumber) {
